exec dbo.add_sample '
{
    ...
    "description": "Database in Microsoft Fabric, have significantly lowered the barrier for developers to create innovative AI applications. These innovations bring AI closer to data, empowering every developer to build an AI app natively and in a more secure manner. Imagine you''re the founder of Contoso, a rapidly growing e-commerce startup. As your online store grows, you realize that many customer inquiries are about basic product information: price, availability, and specific features. To automate these routine questions, you decide to build a chatbot. In this post, we''ll guide you through the process of creating a chatbot that can efficiently handle these product-related queries, freeing up your customer support team to focus on more complex issues.",
    "details": {
